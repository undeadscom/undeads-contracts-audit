...
View Source: [\contracts\persons\Zombies.sol](..\contracts\persons\Zombies.sol)

**↗ Extends: [Actors](Actors.md)**
...
```solidity
function (address router_, uint256 start_) public nonpayable Actors 
```
