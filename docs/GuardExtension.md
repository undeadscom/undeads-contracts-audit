...
View Source: [\contracts\utils\GuardExtension.sol](..\contracts\utils\GuardExtension.sol)

**↗ Extends: [Guard](Guard.md)**
**↘ Derived Contracts: [Actors](Actors.md), [Humans](Humans.md), [Items](Items.md), [Marketplace](Marketplace.md), [MarketplaceStorage](MarketplaceStorage.md), [MarketplaceTreasury](MarketplaceTreasury.md), [MysteryBox](MysteryBox.md), [Potions](Potions.md), [UDSToken](UDSToken.md), [UGoldToken](UGoldToken.md)**
...
```solidity
function (address rights_) internal nonpayable
```
