...
View Source: [\contracts\manage\interfaces\IManagement.sol](..\contracts\manage\interfaces\IManagement.sol)
...
event AdminChanged(address indexed signer, address indexed oldAdmin, address indexed newAdmin);
event ActionAdded(uint256  id, address indexed author, address indexed target, bytes4  signature);
...
event PromillesSet(address indexed signer, address indexed investor, uint256  promilles);
event PromillesChangeRequest(address indexed signer, address indexed investor, uint256  promilles);
event Distributed(address indexed distributor, uint256  total, uint256  remains);
```
