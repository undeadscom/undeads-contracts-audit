...
View Source: [@openzeppelin\contracts-upgradeable\access\AccessControlUpgradeable.sol](..\@openzeppelin\contracts-upgradeable\access\AccessControlUpgradeable.sol)
...
**↘ Derived Contracts: [AccessControlEnumerableUpgradeable](AccessControlEnumerableUpgradeable.md)**
